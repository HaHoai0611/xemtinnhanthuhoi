...
`
  ...
  saved_what_btn.onclick = () => {
    Swal.fire({
      ...
      html: `
        <p>Khi bạn mở khung chat với ai đó, FB sẽ gửi tin nhắn về, Bot nài sẽ bắt lấy và lưu lại.</p>
  ...
  deleted_what_btn.onclick = () => {
    Swal.fire({
      icon: "question",
      title: "Làm sao Bot này biết được nội dung tin nhắn bị thu hồi?",
      html: `
  ...
  deleted_list_what_btn.onclick = () => {
    Swal.fire({
      ...
      html: `
        ...
        <p>DKS_RSFB sẽ xóa những tin trong khung, giúp khung gọn gàng, dễ nhìn hơn.</p>
